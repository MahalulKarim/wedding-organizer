        ...
        <div class="row">
            ...
            <div class="col-8">
                ...
                <section class="col-6 justify-content-center mb-3">
                    ...
                    <form class="form-container" method="POST" action="s_pesan.php" enctype="multipart/form-data">
                        <h5 class="text-center font-weight-bold col-md-12"> Masukan Data Pesanan Anda </h5><br>
                        <div class="row g-3">
                            <div class="col-md-6">
                                <input type='hidden' value="<?php echo $data['id_produk'] ?>" name="idproduk">
                                <input type='hidden' value="<?php echo $hasil['id_user'] ?>" name="iduser">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control form-control-sm" name="acara" required>
                            </div>
                        </div>
                        <br>
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control form-control-sm" name="alamatacara" autocomplete="off" required>
                            </div>
                            <div class="col-md-6">
                                <label for="inputEmail4" class="form-label">Jumlah Undangan</label>
                                <input type="number" class="form-control form-control-sm " name="jumlah">
                            </div>
                        </div>
                        <div class="row g-3">
                            <div class="col-md-6">
                        ...
                        <br>
                        <br>
                        <button type="submit" class="btn btn-primary" name="pesan" onclick="return confirm('Pastikan Data Yang Anda Masukan Sudah Benar') ">Pesan</button>
                        <a href="semua_paket.php" class="btn btn-danger">Batal/Kembali</a>
