...
<body>
    ...
    <div class="container-fluid pt-5 mb-6">
        ...
        <div class="row row-cols-4 mb-5">
            ...
            <div class="col">
                <a href="wishlist.php" class="btn btn-sm btn-success">Kembali</a>
            ...
            <div class="col-4 text-center">
                ...
                <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                    ...
                    if (mysqli_num_rows($result1) < 1) {
                        ...
                        $query2 = "SELECT * FROM wishlist WHERE id_user='$iduser'";
                        $result2 = mysqli_query($db, $query2);
                        $data2 = mysqli_fetch_array($result2);
                        if (mysqli_num_rows($result2) < 1) { ?>
                            <a href="f_wishlist.php?id=<?php echo $data['id_produk'] ?>" class="btn btn-primary">Hapus</a>
                        <?php } ?>
