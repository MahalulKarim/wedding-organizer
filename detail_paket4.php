...
<body>
    ...
    <div class="container-fluid pt-5 mb-6">
        <h2 class="text-center">Detail Paket</h2>
        <a href="semua_paket.php" class="btn btn-sm btn-success" data-toggle="tooltip" data-placement="left" title="Kembali"><i class="fas fa-arrow-left"></i></a>
        <hr>
        <?php
        //mencari detail paket
        if (isset($_GET['id'])); {
            $id = $_GET['id'];
            $query = "SELECT u.nama,p.* FROM users u, produk p WHERE p.id_user=u.id_user AND p.id_produk='$id'";
